...
function ContactForm() {
  ...
  const handleSendMail = async (e) => {
    ...
    try {
      ...
      // Web3Forms API Key (directly included here)
      const WEB3FORMS_API_KEY = "ce1a9d31-d244-4814-a767-2c21158a3bf4"; // Your Web3Forms API Key
      ...
      toast.error(error?.response?.data?.message || "Error occurred while sending.");
    } finally {
      setIsLoading(false);
    }
  };
